...
var jdd = {
    ...
    loadSampleData: function () {
        $('#textarealeft').val("TableInfo{name='resofprevsubtest', columns={testid=Column{name='testid', type='INTEGER', affinity='3', notNull=true, primaryKeyPosition=0}, id=Column{name='id', type='INTEGER', affinity='3', notNull=true, primaryKeyPosition=1}, attempted=Column{name='attempted', type='INTEGER', affinity='3', notNull=true, primaryKeyPosition=0}, gotmarks=Column{name='gotmarks', type='INTEGER', affinity='3', notNull=true, primaryKeyPosition=0}, wrong=Column{name='wrong', type='INTEGER', affinity='3', notNull=true, primaryKeyPosition=0}}, foreignKeys=[], indices=[]}");
        ...
        $('#textarearight').val("TableInfo{name='resofprevsubtest', columns={gotmarks=Column{name='gotmarks', type='INTEGER', affinity='3', notNull=false, primaryKeyPosition=0}, testid=Column{name='testid', type='INTEGER', affinity='3', notNull=false, primaryKeyPosition=0}, id=Column{name='id', type='INTEGER', affinity='3', notNull=false, primaryKeyPosition=1}, attempted=Column{name='attempted', type='INTEGER', affinity='3', notNull=false, primaryKeyPosition=0}, wrong=Column{name='wrong', type='INTEGER', affinity='3', notNull=false, primaryKeyPosition=0}}, foreignKeys=[], indices=[]}");
    },
